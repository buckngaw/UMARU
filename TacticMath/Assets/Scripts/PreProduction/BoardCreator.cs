...
public class BoardCreator : MonoBehaviour {
    ...
    // theliquidfire.com/2015/05/18/tactics-rpg-board-generator/
    //board creator to be a visual editor
    ...
    //Dictionary which maps from a Point struct to a Tile instance
    ...
    //hand modify a level a single tile
    public void Grow()
    {
        GrowSingle(pos);
    }
    ...
    //Growing and Shrinking tiles in a random area
    ...
    //updating the position of our Tile Selection Indicator
    ...
    //stores each of the tile’s position and height data in a list of Vector3 : persist the data
    public void Save()
    {
    ...
    //restore a LevelData which they had previously saved
    public void Load()
    {
        Clear();
        if (levelData == null)
